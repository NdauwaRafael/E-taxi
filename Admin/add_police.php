...
<div id="registration_status"></div>
        <button type="button" id="register_police_now" class="btn btn-default" style="  background-color: #6d4c41;
...
$(".go-home").click(function(){
    ...
    $("#register_police_now").click(function(){
        ...
        if (fname1==''||lname1==''||email1==''||phone1==''||gender1==''||post1==''||password1==''||cpassword1=='') {
         $("#registration_status").html('Fill In All Empty Fields, A driver Cannot Be Added With Empty Fields').css("color","red");
        }else{
            if(password1==cpassword1){
                $.post("add.config.php",{fname:fname1, lname:lname1, email:email1, gender:gender1, post:post1, password:password1, phone:phone1 },function(data){
                        
                        if(data=='Success...'){
                            $("#Owner_reg_taxi_frm")[0].reset();
                            $("#registration_status").html('<div class="alert alert-success" role="alert"> <i class="fa fa-motorcycle" aria-hidden="true"></i> You Have Successfuly <i class="fa fa-thumbs-up fa-spin fa-fw" aria-hidden="true"></i><span class="sr-only">Loading...</span> Registered This Police Officer To Online E-taxi, The Police will be able to access full details once they log on to their account. Note: A police account have access to customer and car owner and driver details and thus risky in wrong hands <img src="../assets/icons/48/police-48.png">. <i class="fa fa-cog fa-spin fa-3x fa-fw"></i> <span class="sr-only">Loading...</span></div>');
                        }else{
