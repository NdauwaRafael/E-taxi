<form action="login.php" method="post" id="Owner_reg_frm">
...
<div id="registration_status"></div>
        <button type="button" id="register_owner_now" class="btn btn-default" style="  background-color: #6d4c41;
  padding-left: 15px; color:#ccc;" >Registration </button>


      </form>
<script>
    $("#register_owner_now").click(function(){
        ...
        if (fname1==''||lname1==''||email1==''||phone1==''||gender1==''||password1==''||cpassword1=='') {
            ...
            if(password1==cpassword1){
                $.post("taxiOwner/config/reg.php",{fname:fname1, lname:lname1, email:email1, gender:gender1, password:password1,phone:phone1 },function(data){
                        $("#registration_status").html(data);
                        if(data=='Success...'){
                            $("#Owner_reg_frm")[0].reset();
